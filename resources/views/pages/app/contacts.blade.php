                                ...
                                <div class="modal-content">
                                    <form action="{{ route('contacts.store') }} " method="POST">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title add-title" id="addContactModalTitleLabel1">Add
                                                Contact
                                            </h5>
                                            <h5 class="modal-title edit-title" id="addContactModalTitleLabel2"
                                                style="display: none;">Edit Contact</h5>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            <div class="contact-email">
                                                                <input type="text" id="c-email" name="email"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="contact-location">
                                                                <input type="text" id="c-location" name="linkedin"
                            ...
                            <div class="item-content">
                                <div class="user-profile">
                                    ...
                                    <div class="user-meta-info">
                                        <p class="user-name" data-name="Alan Green">{{ $contact['name'] }}</p>
                                        <p class="user-work" data-occupation="Web Developer">
                                            {{ $contact['occupation'] }}</p>
                                    </div>
                                </div>
                                <div class="user-email">
                                ...
                                <div class="user-phone">
                                    ...
                                    <p class="usr-ph-no" data-phone="{{ $contact['phone'] }}">{{ $contact['phone'] }}
                                    </p>
                                </div>
                                <div class="action-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
